  ...
  return (
    <>
      ...
      {scrolled && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-coral hover:bg-coral-light text-white rounded-full flex items-center justify-center shadow-xl transition-all duration-300 hover:scale-110"
        >
